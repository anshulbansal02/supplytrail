        ...
        <div>
            <div className="create-product-background">
                <div className="create-product-container">
                    <div className="container-create-product">
                        <img
                            src={Logo}
                            alt="logo"
                            className="logo-create-product"
                        />
                        <img
                            src={login}
                            alt="login-create-product"
                            className="login-image-create-product"
                        />
                    </div>

                    <div className="container-2-create-product">
                        <form
                            className="create-product-info"
                            id="create-product"
                        >
              ...
              <input className="label-input-create-product" onChange={(e) => { setProductID(e.target.value)}} /> */}
                            ...
                            <input
                                className="label-input-create-product"
                                onChange={(e) => {
